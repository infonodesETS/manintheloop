...
│   ├── NETWORKS_LAYOUT.md
│   └── typography.html            ← Design system reference (open in browser)
└── STATUS.md                  ← this file
```
