...
const TRANSLATIONS = {
  it: {
    ...
    'map.intro':          'In questa pagina è possibile tracciare alcuni degli investimenti più rilevanti dal Paese di origine alle società di un Paese terzo.',
    ...
    'map.arc_colors':     'Seleziona un Paese per visualizzare i flussi di investimento. Con il selettore in alto sulla mappa (<strong>in / out / both</strong>) scegli cosa mostrare:',
    'map.arc_blue':       '<strong>out</strong> — un soggetto del Paese selezionato ha investito in una società di un altro Paese (capitali in uscita).',
    'map.arc_red':        '<strong>in</strong> — una società del Paese selezionato ha ricevuto investimenti da un soggetto di un altro Paese (capitali in entrata).',
    'map.arc_purple':     '<strong>both</strong> — mostra contemporaneamente entrambe le informazioni. Se tra due Paesi il denaro scorre in tutti e due i sensi, vedrai due archi affiancati, uno blu e uno rosso.',
    'map.arc_click':      '<strong>Cliccando sui singoli archi, si aprirà un box a sinistra con il dettaglio di tutte le relazioni tra i soggetti presenti nel nostro database.</strong>',
    ...
    'map.go_to_country_report': 'Vai alla scheda Paese →',
    ...
    'about.team_list':    '<li>Davide Del Monte — Coordinatore e Lead Researcher</li><li>Laura Carrer — Researcher</li><li>Andrea Daniele Signorelli — Researcher</li><li>Andrea Nelson Mauro [DataPitch] — Developer e Data expert</li><li>Emma Besseghini [DataPitch] — Junior Researcher</li>',
    ...
    'onboard.1_title':   '① Due sezioni, due domande',
    'onboard.1_desc':    'La sezione "Finanziamenti EU" segue il flusso del denaro pubblico europeo nel settore della difesa: chi lo riceve, in collaborazione con chi e per quali scopi. La sezione "Investimenti globali" mostra invece gli investimenti (privati e pubblici) nelle aziende del settore e le collaborazioni tra i soggetti.',
    'onboard.2_title':   '② Tre modi di leggere i dati',
    'onboard.2_desc':    'Dentro ogni sezione hai tre viste: la Mappa (i finanziamenti e gli investimenti paese per paese), la Rete (le connessioni tra aziende, investitori, università e istituzioni) e alcuni numeri chiave che ci sembrano significativi.',
    'onboard.3_title':   '③ Cerca e approfondisci',
    'onboard.3_desc':    'Nella sezione "Search" trovi la scheda di ogni singola entità presente nel nostro database. Oppure parti dalla Mappa o dalla Rete e clicca un soggetto per aprire i suoi dettagli. Nella sezione "Pubblicazioni" trovi le nostre inchieste e i nostri report sul tema delle armi autonome.',
    'onboard.4_title':   '④ Dubbi?',
    'onboard.4_desc':    'Se vuoi saperne di più su di noi, sugli obiettivi del progetto o sulle terminologie usate, nella sezione "About" troverai (quasi!) tutto.',
  ...
  en: {
    ...
    'map.arc_colors':     'Select a country to see its investment flows. Use the selector at the top of the map (<strong>in / out / both</strong>) to choose what to show:',
    'map.arc_blue':       '<strong>out</strong> — an entity from the selected country has invested in a company in another country (capital flowing out).',
    'map.arc_red':        '<strong>in</strong> — a company in the selected country has received investment from an entity in another country (capital flowing in).',
    'map.arc_purple':     '<strong>both</strong> — shows both at the same time. If money flows both ways between two countries, you\'ll see two side-by-side arcs, one blue and one red.',
    'map.arc_click':      '<strong>Click on individual arcs to open a panel on the left with the full detail of all the relationships between the entities in our database.</strong>',
    ...
    'map.loading':           'Loading map data…',
    'map.go_to_country_report': 'Go to country report →',
    ...
    'kf.caveat_scope':         'The "defence tech" scope is provisional. A company falls inside it if it takes part in EDF projects, if it is classified as defence in the database or in the Aerospace & Defence ETF, or if Crunchbase assigns it a military, aerospace, satellite or national security sector. Sector labels are generic, though, so the scope errs on the side of leaving companies out. The criteria live in data/defence_criteria.json.',
    ...
    'about.team_list':    '<li>Davide Del Monte — Coordinator and Lead Researcher</li><li>Laura Carrer — Researcher</li><li>Andrea Daniele Signorelli — Researcher</li><li>Andrea Nelson Mauro [DataPitch] — Developer and Data expert</li><li>Emma Besseghini [DataPitch] — Junior Researcher</li>',
    ...
    'onboard.1_title':   '① Two sections, two questions',
    'onboard.1_desc':    'The "EU Funding" section follows the flow of European public money into the defence sector: who receives it, together with whom and for what purposes. The "Global Investments" section shows instead the investments (private and public) in companies in the sector, and the collaborations between actors.',
    'onboard.2_title':   '② Three ways to read the data',
    'onboard.2_desc':    'Within each section you have three views: the Map (funding and investments country by country), the Network (the connections between companies, investors, universities and institutions) and a few key figures that seem significant to us.',
    'onboard.3_title':   '③ Search and dig deeper',
    'onboard.3_desc':    'In the "Search" section you find the profile of every single entity in our database. Or start from the Map or the Network and click on an actor to open its details. In the "Publications" section you find our investigations and reports on autonomous weapons.',
    'onboard.4_title':   '④ Questions?',
    'onboard.4_desc':    'If you want to know more about us, the goals of the project or the terminology we use, the "About" section has (almost!) everything.',
  ...
  fr: {
    ...
    'map.arc_colors':     'Sélectionnez un pays pour voir ses flux d\'investissement. Avec le sélecteur en haut de la carte (<strong>in / out / both</strong>), choisissez ce qui s\'affiche :',
    'map.arc_blue':       '<strong>out</strong> — une entité du pays sélectionné a investi dans une société d\'un autre pays (capitaux sortants).',
    'map.arc_red':        '<strong>in</strong> — une société du pays sélectionné a reçu des investissements d\'une entité d\'un autre pays (capitaux entrants).',
    'map.arc_purple':     '<strong>both</strong> — affiche les deux informations en même temps. Si l\'argent circule dans les deux sens entre deux pays, vous verrez deux arcs côte à côte, un bleu et un rouge.',
    'map.arc_click':      '<strong>Cliquez sur les arcs pour ouvrir un panneau à gauche présentant le détail de toutes les relations entre les entités de notre base de données.</strong>',
    ...
    'map.go_to_country_report': 'Voir la fiche pays →',
    ...
    'about.team_list':    '<li>Davide Del Monte — Coordinateur et chercheur principal</li><li>Laura Carrer — Chercheuse</li><li>Andrea Daniele Signorelli — Chercheur</li><li>Andrea Nelson Mauro [DataPitch] — Développeur et expert en données</li><li>Emma Besseghini [DataPitch] — Chercheuse junior</li>',
    ...
    'onboard.1_title':   '① Deux sections, deux questions',
    'onboard.1_desc':    'La section « Financements UE » suit le flux de l\'argent public européen dans le secteur de la défense : qui le reçoit, avec quels partenaires et à quelles fins. La section « Investissements mondiaux » montre quant à elle les investissements (privés et publics) dans les entreprises du secteur et les collaborations entre les acteurs.',
    'onboard.2_title':   '② Trois façons de lire les données',
    'onboard.2_desc':    'Dans chaque section, vous disposez de trois vues : la Carte (les financements et les investissements pays par pays), le Réseau (les connexions entre entreprises, investisseurs, universités et institutions) et quelques chiffres clés qui nous semblent significatifs.',
    'onboard.3_title':   '③ Rechercher et approfondir',
    'onboard.3_desc':    'Dans la section « Recherche », vous trouvez la fiche de chaque entité présente dans notre base de données. Ou partez de la Carte ou du Réseau et cliquez sur un acteur pour ouvrir ses détails. Dans la section « Publications », vous trouvez nos enquêtes et nos rapports sur les armes autonomes.',
    'onboard.4_title':   '④ Des questions ?',
    'onboard.4_desc':    'Si vous voulez en savoir plus sur nous, sur les objectifs du projet ou sur la terminologie employée, la section « À propos » contient (presque !) tout.',
  ...
  es: {
    ...
    'map.arc_colors':     'Selecciona un país para ver sus flujos de inversión. Con el selector en la parte superior del mapa (<strong>in / out / both</strong>) elige qué mostrar:',
    'map.arc_blue':       '<strong>out</strong> — una entidad del país seleccionado ha invertido en una empresa de otro país (capitales salientes).',
    'map.arc_red':        '<strong>in</strong> — una empresa del país seleccionado ha recibido inversión de una entidad de otro país (capitales entrantes).',
    'map.arc_purple':     '<strong>both</strong> — muestra ambas informaciones a la vez. Si el dinero fluye en los dos sentidos entre dos países, verás dos arcos contiguos, uno azul y uno rojo.',
    'map.arc_click':      '<strong>Haz clic en los arcos para abrir un panel a la izquierda con el detalle de todas las relaciones entre las entidades de nuestra base de datos.</strong>',
    ...
    'map.go_to_country_report': 'Ver la ficha del país →',
    ...
    'kf.caveat_scope':         'El perímetro «defence tech» es provisional. Una empresa entra en él si participa en proyectos EDF, si está clasificada como defensa en la base o en el ETF Aerospace & Defence, o si Crunchbase le asigna un sector militar, aeroespacial, satelital o de seguridad nacional. Las etiquetas sectoriales son sin embargo genéricas, de modo que el perímetro tiende a excluir por defecto. Los criterios están en data/defence_criteria.json.',
    ...
    'about.team_list':    '<li>Davide Del Monte — Coordinador e investigador principal</li><li>Laura Carrer — Investigadora</li><li>Andrea Daniele Signorelli — Investigador</li><li>Andrea Nelson Mauro [DataPitch] — Desarrollador y experto en datos</li><li>Emma Besseghini [DataPitch] — Investigadora junior</li>',
    ...
    'onboard.1_title':   '① Dos secciones, dos preguntas',
    'onboard.1_desc':    'La sección "Financiación UE" sigue el flujo del dinero público europeo en el sector de la defensa: quién lo recibe, en colaboración con quién y con qué fines. La sección "Inversiones globales" muestra en cambio las inversiones (privadas y públicas) en las empresas del sector y las colaboraciones entre los actores.',
    'onboard.2_title':   '② Tres formas de leer los datos',
    'onboard.2_desc':    'Dentro de cada sección tienes tres vistas: el Mapa (la financiación y las inversiones país por país), la Red (las conexiones entre empresas, inversores, universidades e instituciones) y algunas cifras clave que nos parecen significativas.',
    'onboard.3_title':   '③ Busca y profundiza',
    'onboard.3_desc':    'En la sección "Búsqueda" encuentras la ficha de cada entidad presente en nuestra base de datos. O parte del Mapa o de la Red y haz clic en un actor para abrir sus detalles. En la sección "Publicaciones" encuentras nuestras investigaciones e informes sobre las armas autónomas.',
    'onboard.4_title':   '④ ¿Dudas?',
    'onboard.4_desc':    'Si quieres saber más sobre nosotros, sobre los objetivos del proyecto o sobre la terminología utilizada, en la sección "Acerca de" encontrarás (¡casi!) todo.',
